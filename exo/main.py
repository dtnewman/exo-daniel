...
mock_inference_engine_latency = args.mock_inference_engine_latency
inference_engine = get_inference_engine(inference_engine_name, shard_downloader, mock_inference_engine_latency)
...
api = ChatGPTAPI(
  ...
  is_using_adaptive_partitioning=args.partitioning_strategy == "adaptive"
)
