...
class TestHybridPartitioningStrategy(unittest.TestCase):
    def test_partition(self):
        ...
        topology.update_node(
            "node1",
            DeviceCapabilities(model="test1", chip="test1", memory=4000, flops=DeviceFlops(fp32=4.0, fp16=8.0, int8=16.0)),
        )
        topology.update_node(
            "node2",
        ...
        topology.update_node(
            "node3",
            DeviceCapabilities(model="test3", chip="test3", memory=10000, flops=DeviceFlops(fp32=10.0, fp16=20.0, int8=40.0)),
        )
